 ...
 */
/** 分层 code → 中文短标签 */
export const WAREHOUSE_LAYER_LABELS = {
    ODS: 'ODS 贴源数据',
    DWD: 'DWD 明细数据',
    DWS: 'DWS 汇总数据',
    ADS: 'ADS 应用数据',
...
export const WAREHOUSE_LAYER_TAG_TYPES = {
    ODS: '',
    DWD: 'success',
    DWS: 'warning',
    ADS: 'danger',
...
export const WAREHOUSE_LAYER_COLORS = {
    ODS: '#909399',
    DWD: '#67C23A',
    DWS: '#E6A23C',
    ADS: '#F56C6C',
...
export const WAREHOUSE_LAYER_ICONS = {
    ODS: 'Folder',
    DWD: 'Document',
    DWS: 'DataAnalysis',
    ADS: 'TrendCharts',
 ...
 * 未知/空值返回"未分层"。
 */
export function getWarehouseLayerMeta(code) {
