...
describe("performance admin navigation", () => {
  ...
  it("uses the captured SVG for the remaining settings menus", () => {
    const cases = [
      { key: "evaluation-questions", dataIcon: "EvaluationQuestionsOutlined", viewBox: "0 0 16 16", svgFill: void 0, pathFill: void 0, paths: [EVALUATION_QUESTIONS_ICON_PATH] },
      { key: "permissions", dataIcon: "PermissionsOutlined", viewBox: void 0, svgFill: "none", pathFill: "#646A73", paths: [PERMISSIONS_ICON_PATH] },
      { key: "system", dataIcon: "SystemSettingsOutlined", viewBox: void 0, svgFill: "none", pathFill: "currentColor", paths: [SYSTEM_SETTINGS_ICON_PATH] }
    ];
