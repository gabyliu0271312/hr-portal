    ...
    <div v-if="systemInfo" class="sd-body">
      <div class="sd-section">
        ...
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="资源数量" :span="2">
            {{ systemInfo.resource_count }} 个（启用 {{ systemInfo.active_count }}）
          </el-descriptions-item>
      ...
      <div class="sd-section">
        <div class="sd-section-title">资源（{{ systemInfo.resource_count }}）</div>
        <div class="sd-list" v-if="systemInfo.resources?.length">
          <div
            v-for="c in systemInfo.resources"
            :key="c.id"
            class="sd-list-item"
          >
            <div class="sd-list-main">
              <div class="sd-list-name">
                {{ c.system_name }} - {{ c.adapter_code || c.resource_code }}
