...
const form = reactive({ sla_code: '', sla_name: '', target_type: 'system', target_id: 1, success_rate_target: 0.99, p95_duration_ms_max: null, window_hours: 24 });
...
async function save() {
    try {
        const payload = {
            ...
            p99_duration_ms_max: form.p99_duration_ms_max ?? undefined,
        };
        if (editingId.value)
            await slaApi.updateConfig(editingId.value, payload);
        else
            await slaApi.createConfig(payload);
...
async function viewRecords(row) {
    ...
    try {
        const res = await slaApi.records(row.id);
...
async function confirmDelete(row) {
    try {
        ...
        await slaApi.deleteConfig(row.id);
...
__VLS_31.slots.default;
{
    ...
    (row.success_rate_target ? (row.success_rate_target * 100).toFixed(1) + '%' : '-');
}
var __VLS_31;
...
__VLS_39.slots.default;
{
    ...
    const __VLS_41 = __VLS_asFunctionalComponent(__VLS_40, new __VLS_40({
        type: (row.latest_met ? 'success' : 'danger'),
        size: "small",
    }));
...
const __VLS_73 = __VLS_asFunctionalComponent(__VLS_72, new __VLS_72({
    ...
    title: (__VLS_ctx.editingId ? '编辑 SLA' : '新建 SLA'),
    width: "500px",
}));
...
const __VLS_85 = __VLS_asFunctionalComponent(__VLS_84, new __VLS_84({
    modelValue: (__VLS_ctx.form.sla_code),
...
const __VLS_93 = __VLS_asFunctionalComponent(__VLS_92, new __VLS_92({
    modelValue: (__VLS_ctx.form.sla_name),
}));
...
const __VLS_121 = __VLS_asFunctionalComponent(__VLS_120, new __VLS_120({
    modelValue: (__VLS_ctx.form.target_id),
    min: (1),
}));
...
const __VLS_129 = __VLS_asFunctionalComponent(__VLS_128, new __VLS_128({
    modelValue: (__VLS_ctx.form.success_rate_target),
    min: (0),
    max: (1),
    step: (0.01),
}));
...
const __VLS_137 = __VLS_asFunctionalComponent(__VLS_136, new __VLS_136({
    modelValue: (__VLS_ctx.form.p95_duration_ms_max),
    min: (1),
}));
...
const __VLS_145 = __VLS_asFunctionalComponent(__VLS_144, new __VLS_144({
    modelValue: (__VLS_ctx.form.window_hours),
    min: (1),
}));
...
__VLS_175.slots.default;
{
    ...
    const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
    (__VLS_ctx.formatDateTime(row.window_start));
    (__VLS_ctx.formatDateTime(row.window_end));
}
var __VLS_175;
...
__VLS_191.slots.default;
{
    ...
    const __VLS_193 = __VLS_asFunctionalComponent(__VLS_192, new __VLS_192({
        type: (row.is_met ? 'success' : 'danger'),
        size: "small",
    }));
...
__VLS_199.slots.default;
{
    ...
    const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
    ((row.unmet_reasons || []).join('; '));
}
var __VLS_199;
var __VLS_171;
var __VLS_167;
/** @type {__VLS_StyleScopedClasses['sla-page']} */ ;
