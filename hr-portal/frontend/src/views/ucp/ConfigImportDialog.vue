  ...
  <el-dialog v-model="visible" title="导入 UCP 配置" width="720px" destroy-on-close @open="onOpen">
    <el-form :model="form" label-width="100px" size="default">
      <el-form-item label="导入范围">
        <el-radio-group v-model="form.target_type">
          ...
          <el-radio-button value="system">仅系统</el-radio-button>
    ...
    <div v-if="result" class="result-box mt-3">
      ...
      <el-row :gutter="12" class="mt-2">
        ...
        <el-col :span="8">
          <el-statistic :value="result.resources.created" :title="'系统 新增'" />
        </el-col>
        <el-col :span="8">
      ...
      <el-row :gutter="12" class="mt-2">
        ...
        <el-col :span="8">
          <el-statistic :value="result.resources.skipped" :title="'系统 跳过'" />
        </el-col>
        <el-col :span="8">
...
const allErrors = computed(() => {
  ...
  return [
    ...
    ...result.value.resources.errors.map((e: any) => ({ type: 'system', ...e })),
