export interface TagFillQuestionTag {
  id: string
  name: string
  description: string
  prompt: string
...
export interface TagFillQuestionRecord {
  id: string
  name: string
  description: string
  creator: string
  createdAt: string
  remark: string
  tags: TagFillQuestionTag[]
}

export const TAG_FILL_QUESTION_FIXTURES: TagFillQuestionRecord[] = [
  {
...
export function cloneTagFillQuestion(record: TagFillQuestionRecord): TagFillQuestionRecord {
  return {
    ...record,
