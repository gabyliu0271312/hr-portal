...
const options = [
  { id: 11, name: '测试评级--评级可参与计算开关关闭', review_type: '评级' as const, status: 'active' as const, updated_at: '', config_summary: {} },
  { id: 12, name: '测试评级--评级可参与计算开关打开', review_type: '评级' as const, status: 'active' as const, updated_at: '', config_summary: {} },
]
