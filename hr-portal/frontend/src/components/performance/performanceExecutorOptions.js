export const SUBJECT_EXECUTOR_OPTION = {
    type: 'SUBJECT',
    label: '被评估人',
};
export const CALIBRATION_EXECUTOR_OPTION = {
    type: 'PROJECT_CONFIGURED',
    label: '在项目配置时指定',
};
export const PERFORMANCE_EXECUTOR_OPTIONS = [
...
export const RESULT_COMMUNICATION_EXECUTOR_OPTIONS = PERFORMANCE_EXECUTOR_OPTIONS.filter((option) => option.type === 'REAL_LINE_MANAGER' || option.type === 'VIRTUAL_LINE_MANAGER');
export const REAL_LINE_MANAGER_LEVEL_OPTIONS = [
