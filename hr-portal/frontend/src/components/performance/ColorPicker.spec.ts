...
describe('ColorPicker', () => {
  it('opens the fixed 12-color palette with target icons', async () => {
    ...
    const panel = document.body.querySelector('.performance-color-picker-popover') as HTMLElement
  ...
  it('selects a color, closes, and keeps it active after reopening', async () => {
    ...
    const swatches = document.body.querySelectorAll<HTMLButtonElement>('.performance-color-swatch')
    swatches[3].click()
