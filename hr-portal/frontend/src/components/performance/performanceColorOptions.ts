export interface PerformanceColorOption {
  value: string
  trigger: string
}

export const PERFORMANCE_LEVEL_COLORS: PerformanceColorOption[] = [
...
export function performanceLevelBackground(value: unknown): string {
