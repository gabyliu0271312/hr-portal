...
describe('PerformanceConfirmDialog', () => {
  ...
  it('emits confirm once and disables both actions while deleting', async () => {
    ...
    const buttons = Array.from(document.querySelectorAll<HTMLButtonElement>('.performance-confirm-dialog__button'))
  ...
  it('traps keyboard focus and restores it after closing', async () => {
    ...
    const dialog = document.querySelector('.performance-confirm-dialog') as HTMLElement
