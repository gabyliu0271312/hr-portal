  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { label: 'Pipeline 执行历史', menuCode: 'datasource.ucp_executions' },
      },
      {
        path: 'datasource/ucp/executions/:id',
        name: 'UcpExecDetail',
        component: () => import('@/views/datasource/ucp/PipelineExecDetail.vue'),
        meta: { label: 'Pipeline 执行详情', menuCode: 'datasource.ucp_executions' },
      },
      {
        path: 'datasource/ucp',
        name: 'UcpDataAccess',
        component: () => import('@/views/datasource/ucp/DataAccessIndex.vue'),
        meta: { label: '数据接入', menuCode: 'datasource.ucp_config' },
      },
      {
        path: 'datasource/ucp/config',
        name: 'UcpConfig',
        component: () => import('@/views/datasource/ucp/PipelineConfigList.vue'),
        meta: { label: 'Pipeline 配置', menuCode: 'datasource.ucp_config' },
      },
      {
        path: 'datasource/ucp/circuits',
        name: 'UcpCircuitBreaker',
        component: () => import('@/views/datasource/ucp/CircuitBreakerStatus.vue'),
        meta: { label: '熔断与限流', menuCode: 'datasource.ucp_config' },
      },
      {
      ...
      },
      {
        ...
        meta: { label: '流水线编排', menuCode: 'datasource.ucp_config' },
      },
      {
        path: 'datasource/ucp/monitor',
        name: 'UcpMonitor',
        component: () => import('@/views/datasource/ucp/MonitorDashboardView.vue'),
        meta: { label: '运行监控', menuCode: 'datasource.ucp_config' },
      },
      {
        path: 'datasource/ucp/credentials',
        name: 'UcpCredentialList',
        component: () => import('@/views/datasource/ucp/CredentialListView.vue'),
        meta: { label: '凭证管理', menuCode: 'datasource.ucp_config', hideInMenu: true },
      },
      {
        path: 'datasource/ucp/connectors',
        name: 'UcpConnectorList',
        component: () => import('@/views/datasource/ucp/ConnectorListView.vue'),
        meta: { label: '连接器管理', menuCode: 'datasource.ucp_config', hideInMenu: true },
      },
      {
        path: 'datasource/ucp/pipelines',
        name: 'UcpPipelineList',
        component: () => import('@/views/datasource/ucp/PipelineListView.vue'),
        meta: { label: '流水线管理', menuCode: 'datasource.ucp_config', hideInMenu: true },
      },
      {
