...
DEFAULT_TEMPLATES = [
    {
        ...
        "variables": [
            {"variable_code": "company", "variable_name": "公司", "source_type": "employee_field", "source_key": "公司名称", "required": True},
            {"variable_code": "name", "variable_name": "员工姓名", "source_type": "employee_field", "source_key": "姓名", "required": True},
            {"variable_code": "id_card", "variable_name": "证件号码", "source_type": "employee_field", "source_key": "证件号码"},
    ...
    },
    {
        ...
        "variables": [
            ...
            {"variable_code": "name", "variable_name": "员工姓名", "source_type": "employee_field", "source_key": "姓名", "required": True},
            {"variable_code": "id_card", "variable_name": "证件号码", "source_type": "employee_field", "source_key": "证件号码"},
            {"variable_code": "position", "variable_name": "职位", "source_type": "employee_field", "source_key": "职位"},
