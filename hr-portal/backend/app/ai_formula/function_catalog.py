...
EXECUTABLE_BASE_FUNCTIONS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        "code": "COUNTIF",
        "name": "条件计数",
        "description": "统计满足条件的行数。",
        "parameters": [
            {"name": "range", "type": "any", "description": "要统计的列"},
            {"name": "criteria", "type": "string", "description": "条件，如 \"正式员工\""},
        ],
        "return_type": "number",
    },
    {
        "code": "COUNTIFS",
        "name": "多条件计数",
        "description": "统计同时满足多个条件的行数。",
        "parameters": [
            {"name": "range1", "type": "any", "description": "第一个条件列"},
            {"name": "criteria1", "type": "string", "description": "第一个条件"},
            {"name": "range2", "type": "any", "description": "第二个条件列"},
            {"name": "criteria2", "type": "string", "description": "第二个条件"},
        ],
        "return_type": "number",
    },
    {
        "code": "SUMIF",
        "name": "条件求和",
        "description": "对满足条件的行求和。",
        "parameters": [
            {"name": "range", "type": "any", "description": "条件列"},
            {"name": "criteria", "type": "string", "description": "条件"},
            {"name": "sum_range", "type": "number", "description": "求和列"},
        ],
        "return_type": "number",
    },
    {
    ...
    },
    {
        "code": "AVERAGEIF",
        "name": "条件平均值",
        "description": "计算满足条件的行的平均值。",
        "parameters": [
            {"name": "range", "type": "any", "description": "条件列"},
            {"name": "criteria", "type": "string", "description": "条件"},
            {"name": "average_range", "type": "number", "description": "求平均值列"},
        ],
        "return_type": "number",
    },
    {
