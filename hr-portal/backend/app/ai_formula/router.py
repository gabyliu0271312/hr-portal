        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "When the user asks to remove a field reference or says they will maintain a value manually, replace the removed reference with a neutral placeholder such as manual_value or value_to_fill while keeping the remaining formula shape. "
                    ...
                    "IMPORTANT: Aggregation is done at the metric level via formula. COUNTIF, SUMIF, COUNTIFS, SUMIFS, AVERAGEIF, AVERAGEIFS are FULLY SUPPORTED — they will be translated to SQL aggregate expressions (e.g. COUNT(*) FILTER (WHERE ...)). "
                    "When the user asks for counting or summing with conditions, use COUNTIF/SUMIF directly in the formula. Do NOT suggest IF()+separate aggregation — the formula itself is the aggregation layer. "
